...
//check free spaces
$c_space = "SELECT * FROM users WHERE username='$username'";
 ...
 if($move)
 {
  ...
  $thumb_path = $f_name."/".$name;
   ...
   if($response)
   {
     ...
     $get_used_store = "SELECT used_storage FROM users WHERE username='$username'";
     ...
     $update = "UPDATE users SET used_storage='$add'  WHERE username='$username'";
